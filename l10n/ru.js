OC.L10N.register(
    ...
    "The following groups will be added to every new account" : "Новые учётные записи будут включены в следующие группы ",
    "The following groups will be set to every unconfirmed account and removed when confirmed" : "Новые учётные записи будут включены в следующие группы и удалены из этих групп при подтверждении",
    "The following groups will be set to every confirmed account" : "Новые подтверждённые учётные записи будут включены в следующие группы "
},
