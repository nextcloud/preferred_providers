OC.L10N.register(
    ...
    "The following groups will be added to every new account" : "The following groups will be added to every new account",
    "The following groups will be set to every unconfirmed account and removed when confirmed" : "The following groups will be set to every unconfirmed account and removed when confirmed",
    "The following groups will be set to every confirmed account" : "The following groups will be set to every confirmed account"
},
