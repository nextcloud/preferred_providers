OC.L10N.register(
    ...
    "Reactivate your account" : "Reativar sua conta",
    ...
    "If a deactivated account for that address exists, we've sent a new verification link. It expires in 6 hours." : "Caso exista uma conta desativada associada a esse endereço, enviamos um novo link de verificação. Ele expira em 6 horas.",
    "Enter your email address" : "Digite seu endereço de e-mail",
    "Send reactivation email" : "Enviar e-mail de reativação",
    "Preferred providers token" : "Token do provedor preferencial",
    "WARNING! This token is very important and must be handled carefully. You should only give it to a Nextcloud official!" : "ATENÇÃO! Este token é muito importante e deve ser manuseado com cuidado. Você só deve fornecê-lo a um representante oficial do Nextcloud!",
