OC.L10N.register(
    ...
    "A confirmation mail was sent to {email}. Make sure to confirm the account within 6 hours." : "جەزملەش ئېلخېتى {email} غا ئەۋەتىلدى. 6 سائەت ئىچىدە ھېساباتنى جەزملەشتۈرۈڭ.",
    ...
    "Registration handling app for Nextcloud partners only" : "Nextcloud شىرىكلىرى ئۈچۈنلا تىزىملىتىشنى بىر-تەرەپ قىلىش قورالى",
