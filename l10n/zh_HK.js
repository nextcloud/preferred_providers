OC.L10N.register(
    ...
    "Did you encountered an issue during the sign-up process?" : "在註冊過程中是否遇到問題？",
    "Access your account" : "存取您的賬戶",
    "Welcome to your %s account" : "歡迎使用您 %s 的賬戶",
    "Your %s account %s is now verified!" : "您的%s賬戶%s現在已通過驗證！",
    "Start using %s" : "開始使用 %s",
    "Install mobile or desktop client" : "安裝流動或桌面客戶端",
    "Verify your %s account" : "驗證您的%s賬戶",
    "Just one step left to complete your account setup." : "僅需一步即可完成您的賬戶設置。",
    "Click here to verify your email address" : "點擊此處驗證您的電郵地址",
    "Your %s account has been disabled" : "您的 %s 帳號已被停用",
    "Your %s account %s has been disabled because it was not verified in time." : "因為未及時進行驗證，您的 %s賬戶%s 已被停用。",
    "Please contact your provider for further assistance." : "請聯絡您的服務提供者以獲取進一步的幫助。",
    "Simple signup" : "簡易註冊",
    "A confirmation mail was sent to {email}. Make sure to confirm the account within 6 hours." : "確認郵件已發送到{email}。 請確保在6小時內確認該賬戶。",
    ...
    "The following groups will be added to every new account" : "以下群組將被添加到每個新賬戶中",
    "The following groups will be set to every unconfirmed account and removed when confirmed" : "將為每個未確認的賬戶設置以下群組，並在確認該賬戶後將其刪除",
    "The following groups will be set to every confirmed account" : "將為每個確認的賬戶設置以下群組"
},
"nplurals=1; plural=0;");
