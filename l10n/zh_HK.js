OC.L10N.register(
    ...
    "Preferred Providers" : "更合意的服務提供者",
    "Allow nextcloud to request user accounts" : "允許 Nextcloud 請求用戶帳戶",
    ...
    "The following groups will be added to every new account" : "以下群組將被添加到每個新帳戶中",
    "The following groups will be set to every unconfirmed account and removed when confirmed" : "將為每個未確認的帳戶設置以下群組，並在確認該帳戶後將其刪除",
    "The following groups will be set to every confirmed account" : "將為每個確認的帳戶設置以下群組"
},
"nplurals=1; plural=0;");
